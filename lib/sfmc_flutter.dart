...
/*
  ...
  */
  ...
  static setEventTracking({required String eventName,Map? attributes}) async{
    final bool? result = await _channel.invokeMethod('setEventTracking',
        {"eventName": eventName,"attributes": attributes??{}});
    return result;
  }
  // static trackEvent({required String eventName, List? attributes}) async{
